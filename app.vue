...
// 导航链接
const navLinks = [
  { name: "首页", url: "https://199909.com" },
  { name: "特惠团购", url: "https://tehuituan.cn" },
  { name: "捡便宜", url: "https://jianpianyi.cn" },
  { name: "视频解析", url: "https://parse.shenzjd.com" },
  { name: "热点聚合", url: "https://newshub.shenzjd.com" },
  { name: "资源库", url: "https://my.feishu.cn/wiki/VYxcwTey8iHJVpkBoA9cOqG8nqh?from=from_copylink" },
  { name: "快捷指令", url: "https://binguo.net" },
];
